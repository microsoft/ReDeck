"""FidelityJudge - evaluates E-series rubric items."""
...
class FidelityJudge(BaseJudge):
    """Evaluates content fidelity: E1-E4.
    ...
    rubric_family = "E"
    module_name = "fidelity_judge"
    prompt_filename = "fidelity_judge.system.md"
    ...
    def evaluate(
        ...
        """Evaluate content fidelity against source materials (single-pass)."""
        deck_content = []
